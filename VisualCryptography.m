function [share1, share2, share3] = VisualCryptography(inImg)
...
for i=1:len
    a=x(i);b=y(i);
    pixShare=FunctionGenerateShare(s1a,s1b);
...
for i=1:len
    a=x(i);b=y(i);
    pixShare=FunctionGenerateShare(s0a,s0b);
    share1((a),(2*b-1):(2*b))=pixShare(1,1:2);
    share2((a),(2*b-1):(2*b))=pixShare(2,1:2);
end

share3=bitor(share1, share2);
share3 = ~share3;
